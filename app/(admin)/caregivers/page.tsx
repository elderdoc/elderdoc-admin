...
export default async function CaregiversPage() {
  const [caregivers, careTypeLabels] = await Promise.all([getAllCaregivers(), getCareTypesMap()])
  return (
    <div className="px-8 py-7">
      ...
      <CaregiversClient caregivers={caregivers} careTypeLabels={careTypeLabels} />
    </div>
  )
}
